...
setup(
    ...
    #
    # 1. Create the function you want to run on the CLI in src/podcreator/cli.py
    #    For convenience I usually recommend calling it main()
    #
    # 2. Uncomment this section of the setup.py arguments; this will create
    #    bin/OTIESiteServicesPodCreator (which you can obviously change!) as a script
    #    that will call your main() function, above.
    #
    # entry_points="""\
    # [console_scripts]
    # ClassProject1 = classproject1.cli:main
    # """,
    #
